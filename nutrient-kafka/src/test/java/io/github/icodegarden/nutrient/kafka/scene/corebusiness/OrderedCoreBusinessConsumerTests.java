...
import io.github.icodegarden.nutrient.kafka.reliability.OrderedReliabilityConsumer;
...
//		props.put(PropertiesConstants.RECORD_RELIABILITY_PROCESSOR.getKey(), CompletionBeforePollRecordReliabilityProcessor.class);
		...
		ReliabilityConsumer<Integer, OrderDetail4Test> consumer = new OrderedReliabilityConsumer<>(props, 200, recordReliabilityHandler);
