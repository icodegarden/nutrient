...
import io.github.icodegarden.nutrient.elasticsearch.ElasticsearchClientBuilder;
 ...
 *
 */
public class DemoElasticsearchRepositoryTests {
	...
	DemoElasticsearchRepository dao = new DemoElasticsearchRepository(client);
