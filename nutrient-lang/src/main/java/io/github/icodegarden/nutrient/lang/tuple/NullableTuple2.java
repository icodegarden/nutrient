...
public class NullableTuple2<T1, T2> implements Iterable<Object>, Serializable {
	...
	/**
	 * Map the left-hand part (T1) of this {@link NullableTuple2} into a different value and type,
	 ...
	 * @return a new {@link NullableTuple2} with a different left (T1) value
	 */
	public <R> NullableTuple2<R, T2> mapT1(Function<T1, R> mapper) {
		return new NullableTuple2<>(mapper.apply(t1), t2);
	}

	/**
	 * Map the right-hand part (T2) of this {@link NullableTuple2} into a different value and type,
	 ...
	 * @return a new {@link NullableTuple2} with a different right (T2) value
	 */
	public <R> NullableTuple2<T1, R> mapT2(Function<T2, R> mapper) {
		return new NullableTuple2<>(t1, mapper.apply(t2));
	}
	...
	public boolean equals(@Nullable Object o) {
		...
		return TupleEquals.nullSafeEquals(t1, tuple2.t1) && TupleEquals.nullSafeEquals(t2, tuple2.t2);
	}
