package io.github.icodegarden.nutrient.mqtt;
...
public class MqttSubSample implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MqttSubSample sampleClient = new MqttSubSample(url, clientId, cleanSession, quietMode, userName, password);
	 ...
	 */
	public MqttSubSample(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName,
